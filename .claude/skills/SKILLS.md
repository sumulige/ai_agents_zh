...
| [hierarchical-explanation](./hierarchical-explanation/) | 分层递归解释法写作技能 | 中级 |

### 写作类

| 技能 | 说明 | 难度 |
|------|------|------|
| [hierarchical-explanation](./hierarchical-explanation/) | 分层递归解释法 - 让复杂概念易于理解 | 中级 |
...
### 1.1.0 (2026-01-16)
- 新增 hierarchical-explanation 技能（分层递归解释法）
- 更新 manus-kickoff 技能，集成分层解释风格
- 重写 PROJECT_KICKOFF.md 和 TASK_PLAN.md 模板
